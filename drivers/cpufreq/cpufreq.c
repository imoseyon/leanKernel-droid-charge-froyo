...
int active_states[9] = {1,1,1,1,1,0,1,1,1}; //default enabled states {1400,1300,1200,1000,800,600,400,200,100}
...
ret = sscanf(buf, "%u %u %u %u %u %u %u %u %u", &exp_UV_mV[0],&exp_UV_mV[1],&exp_UV_mV[2],&exp_UV_mV[3],&exp_UV_mV[4],&exp_UV_mV[5],&exp_UV_mV[6],&exp_UV_mV[7],&exp_UV_mV[8]);

// imoseyon - don't allow 7 & 8 to change
exp_UV_mV[7] = 0;
exp_UV_mV[8] = 0;
...
{
return sprintf(buf, "%d %d %d %d %d %d %d %d %d\n", active_states[0],active_states[1],active_states[2],active_states[3],active_states[4],active_states[5],active_states[6],active_states[7],active_states[8]);
}
...
ret = sscanf(buf, "%d %d %d %d %d %d %d %d %d", &active_states[0],&active_states[1],&active_states[2],&active_states[3],&active_states[4],&active_states[5],&active_states[6],&active_states[7],&active_states[8]);
if (ret != 1)
return -EINVAL;
else
return count;
